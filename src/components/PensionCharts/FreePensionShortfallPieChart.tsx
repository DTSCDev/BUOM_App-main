...
interface FreePensionShortfallPieChartProps {
...
export const FreePensionShortfallPieChart: React.FC<FreePensionShortfallPieChartProps> = ({
    ...
    <div className="flex flex-col items-center relative">
      ...
      <div className="flex justify-center flex-wrap gap-4 mt-4">
        <div className="flex flex-col items-center">
          ...
          <div className="text-[8px] text-gray-400 mt-1">SFM-033</div>
        </div>
        <div className="flex flex-col items-center">
          <div className="flex items-center">
          ...
          <div className="text-[8px] text-gray-400 mt-1">SFM-034</div>
        </div>
        <div className="flex flex-col items-center">
          <div className="flex items-center">
          ...
          <div className="text-[8px] text-gray-400 mt-1">SFM-035</div>
        </div>
      </div>
    </div>
  );
